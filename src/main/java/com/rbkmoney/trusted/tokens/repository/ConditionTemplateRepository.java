...
public class ConditionTemplateRepository {
    ...
    public ConditionTemplate get(String key) {
        try {
            ...
            return obj != null && obj.getValue() != null
                    ? objectMapper.readValue(obj.getValue().toString(), ConditionTemplate.class)
                    : null;
        } catch (InterruptedException e) {
            log.error("InterruptedException in ConditionTemplateRepository when get e: ", e);
    ...
    public void create(Row row) {
        try {
            ...
            log.error("InterruptedException in ConditionTemplateRepository when create e: ", e);
            Thread.currentThread().interrupt();
            throw new RiakExecutionException(e);
        } catch (Exception e) {
            log.error("Exception in ConditionTemplateRepository when create e: ", e);
